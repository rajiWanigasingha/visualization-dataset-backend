package com.supermarket.GraphqlData.Entity;

import org.springframework.data.annotation.Id;
import org.springframework.data.mongodb.core.mapping.Document;

@Document("supermarket_data")
public class SuperMarketEntity {
    ...
    public SuperMarketEntity(String _id, String invoiceId, String branch, String city, String customerType, String gender, String productLine, double unitPrice, Integer quantity, double taxFive, double total, String date, String time, String payment, double cogs, double grossMarginPercentage, double grossIncome, double rating) {
        this._id = _id;
        this.invoiceId = invoiceId;
        this.branch = branch;
        this.city = city;
